 ...
 * `hw/top_athos/dv/env/seq_lib/chip_sw_gpio_smoke_vseq.sv`. The DV test
 ...
 * - On the nexys video board (chip_athos_nexysvideo.sv), pins 20-23 are
 *   grounded and pins 16-19 are reserved for JTAG, while
 * - On the OpenTitan ASIC (chip_athos_asic.sv), pins 20-31 are grounded and
